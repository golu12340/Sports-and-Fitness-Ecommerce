            ...
            <div class="row g-5">
                ...
                <div class="col-md-6 col-lg-6">
                    ...
                    <form class="needs-validation" action="order.php" method="post">
                        ...
                        <div class="my-3">
                            <div class="form-check">
                                <label class="form-check-label" for="UPI"> UPI make payment to 7507993833@paytm of order amount and send message from contact us with payment id is usually takes 2hr to complete status </label>
                                <input id="credit" name="paymentMethod" type="radio" class="form-check-input" value="UPI" checked required>
